...
export default function Footer(): React.JSX.Element {
  return (
    <footer className="bg-zinc-50 border-t border-zinc-200" id="contact">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href="#" className="flex items-center space-x-2 mb-4">
             ...
             <p className="text-zinc-600 text-sm leading-relaxed mb-4">
               Your trusted destination for premium electronics. Shop the best deals on watches, phones, laptops, and more.
            </p>
        ...
        {/* Bottom bar */}
        <div className="pt-8 border-t border-zinc-200 flex flex-col sm:flex-row justify-between items-center">
           <p className="text-zinc-500 text-sm">
             © {new Date().getFullYear()} Banazon. All rights reserved.
          </p>
          <p className="text-zinc-400 text-sm mt-2 sm:mt-0">
            Made with ❤️ for customers worldwide
          </p>
        </div>
      </div>
    </footer>
